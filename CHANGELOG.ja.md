...
- SCM コマンドのコンテキストを優先して、対象のリポジトリと入力欄を選ぶように改善した。これにより、マルチルートワークスペースや入れ子の Git リポジトリでも、より適切にコミットメッセージを挿入できるようにした。貢献者: [@andreescocard](https://github.com/andreescocard)
